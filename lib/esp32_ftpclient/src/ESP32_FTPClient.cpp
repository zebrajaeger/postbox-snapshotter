...
ESP32_FTPClient::ESP32_FTPClient(const char* _serverAdress, uint16_t _port, const char* _userName, const char* _passWord, uint16_t _timeout, uint8_t _verbose){
  userName = _userName;
  passWord = _passWord;
...
ESP32_FTPClient::ESP32_FTPClient(const char* _serverAdress, const char* _userName, const char* _passWord, uint16_t _timeout, uint8_t _verbose){
  userName = _userName;
  passWord = _passWord;
  serverAdress = _serverAdress;
  port = 21;
...
void ESP32_FTPClient::enableDebug(){
    verbose = 2;
}